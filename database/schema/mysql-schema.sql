...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `fuel_tank_account_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fuel_tank_account_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `fuel_tank_id` bigint unsigned NOT NULL,
  `rule` varchar(255) NOT NULL,
  `value` json NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fuel_tank_account_rules_fuel_tank_id_rule_index` (`fuel_tank_id`,`rule`),
  KEY `fuel_tank_account_rules_fuel_tank_id_index` (`fuel_tank_id`),
  CONSTRAINT `fuel_tank_account_rules_fuel_tank_id_foreign` FOREIGN KEY (`fuel_tank_id`) REFERENCES `fuel_tanks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `fuel_tank_accounts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fuel_tank_accounts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `fuel_tank_id` bigint unsigned NOT NULL,
  `wallet_id` bigint unsigned NOT NULL,
  `tank_deposit` varchar(255) NOT NULL DEFAULT '0',
  `user_deposit` varchar(255) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fuel_tank_accounts_fuel_tank_id_wallet_id_index` (`fuel_tank_id`,`wallet_id`),
  KEY `fuel_tank_accounts_fuel_tank_id_index` (`fuel_tank_id`),
  KEY `fuel_tank_accounts_wallet_id_index` (`wallet_id`),
  CONSTRAINT `fuel_tank_accounts_fuel_tank_id_foreign` FOREIGN KEY (`fuel_tank_id`) REFERENCES `fuel_tanks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fuel_tank_accounts_wallet_id_foreign` FOREIGN KEY (`wallet_id`) REFERENCES `wallets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `fuel_tank_dispatch_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fuel_tank_dispatch_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `fuel_tank_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fuel_tank_dispatch_rules_fuel_tank_id_rule_set_id_index` (`fuel_tank_id`,`rule_set_id`),
  KEY `fuel_tank_dispatch_rules_fuel_tank_id_rule_set_id_rule_index` (`fuel_tank_id`,`rule_set_id`,`rule`),
  KEY `fuel_tank_dispatch_rules_fuel_tank_id_index` (`fuel_tank_id`),
  CONSTRAINT `fuel_tank_dispatch_rules_fuel_tank_id_foreign` FOREIGN KEY (`fuel_tank_id`) REFERENCES `fuel_tanks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fuel_tanks` (
  ...
  `reserves_existential_deposit` tinyint(1) DEFAULT NULL,
  `reserves_account_creation_deposit` tinyint(1) DEFAULT NULL,
  `provides_deposit` tinyint(1) NOT NULL DEFAULT '0',
  `is_frozen` tinyint(1) NOT NULL DEFAULT '0',
  `account_count` varchar(255) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `fuel_tanks_public_key_unique` (`public_key`),
  KEY `fuel_tanks_name_index` (`name`),
  KEY `fuel_tanks_owner_wallet_id_index` (`owner_wallet_id`),
  CONSTRAINT `fuel_tanks_owner_wallet_id_foreign` FOREIGN KEY (`owner_wallet_id`) REFERENCES `wallets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (16,'2023_03_07_020741_create_fuel_tanks_table',1);
INSERT INTO `migrations` VALUES (17,'2023_03_07_020932_create_fuel_tank_account_rules_table',1);
INSERT INTO `migrations` VALUES (18,'2023_03_07_020932_create_fuel_tank_dispatch_rules_table',1);
INSERT INTO `migrations` VALUES (19,'2023_03_07_021318_create_fuel_tank_accounts_table',1);
INSERT INTO `migrations` VALUES (20,'2023_03_20_204012_add_signed_at_block',1);
